...
ll /dev   #查看是否fdilink_ahrs-->ttyUSB0  ,其含义是是否fdilink_ahrs 这个别名来代表惯导模块了,后续不管接到哪个 USB 口,使用的时候均不需要考虑端口号变化问题。
```
<<<<<<< HEAD
## 启动时注意（package名：fdilink_ahrs）
```
roslaunch fdilink_ahrs ahrs_driver.launch 
```

=======
>>>>>>> f1df15660ac2b287dff32ea55ef8902a0bd5c2b4
