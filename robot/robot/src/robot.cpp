...
namespace robot
{
    ...
    auto MoveS::executeRT()->int
	{
        ...
        controller()->motorPool().at(0).setTargetVel(0.001);
...
//        }
	...
	auto createPlanRoot()->std::unique_ptr<aris::plan::PlanRoot>
	{
        ...
        plan_root->planPool().add<robot::GetPos>();
        plan_root->planPool().add<robot::FindHome>();
        plan_root->planPool().add<robot::MoveLeg>();
        plan_root->planPool().add<robot::MoveSingleLeg>();
        plan_root->planPool().add<robot::MoveRobot>();
        plan_root->planPool().add<robot::MoveLine>();
        plan_root->planPool().add<robot::MovePlan>();
		return plan_root;
	}
}
